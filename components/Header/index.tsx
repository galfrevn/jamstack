  ...
  return (
    <div className="pointer-events-none fixed top-6 z-30 grid w-full grid-cols-[1fr,min(640px,100%),1fr] px-4">
      <div
        ...
        } transition-all duration-300 pointer-events-auto col-start-2 -mx-px rounded-2xl bg-gray-800/95 px-4 py-3 shadow-surface-glass backdrop-blur will-change-transform [@supports(backdrop-filter:blur(0px))]:bg-[#101010]/[35%]`}
      >
        {animateHeader && (
